...
[SECTION_A]
(Section A · Reading Comprehension에서 보여준 성취도에 대한 해석을 2~3문장으로. 어떤 유형을 잘했고 어떤 유형에서 막혔는지 구체적으로. 단, "Section A에서 0 학생은" 같은 불필요한 시작 문구는 절대로 쓰지 말고 바로 본론으로 시작하세요.)

[SECTION_B]
(Section B · Quantitative Reasoning에 대한 같은 형식의 해석. "Section B에서 0 학생은" 시작 금지.)

[SECTION_C]
(Section C에 대한 해석. "Section C에서" 시작 금지.)

[SECTION_D]
(Section D에 대한 해석. 동일 적용.)

[SECTION_E]
(Section E에 대한 해석. 동일 적용.)

[SECTION_F]
(Section F에 대한 해석. 동일 적용.)

[SECTION_G]
(Section G에 대한 해석. 동일 적용.)
===SECTION_DETAIL_END===
...
(이 학생의 시험 결과를 바탕으로, 중학교 영어에서 만나게 될 모습을 자연스러운 글 형태로 상세하고 구체적으로 서술하세요. 적어도 4~5문단 이상의 충분한 분량으로, 이 학생의 강점이 중학교 내신이나 수행평가에서 어떤 긍정적 역할을 할지, 그리고 보완이 필요한 부분은 중학교 특정 문법 단원이나 독해 시험 유형에서 어떻게 나타날지 차분하고 자세하게 예고하세요.)

## 특히 주의 깊게 볼 지점

(학생의 오답들을 분석하여, 이 학생에게 **가장 시급하게 보완이 필요하거나 중학교 진학 전 반드시 잡아야 할 핵심 취약점 3~5개**를 엄선해서 선정하세요. 단순 나열이 아닌 취약점 우선순위입니다.) 선택된 문제들을 각각 아래 형식으로:

#### Q{n} · {type_label} 
(주의: [detail_retrieval] 같은 영문 type_code 괄호는 절대로 출력하지 마세요. "Q3 · 세부 정보 찾기" 처럼 문항 번호와 한글 유형명만 출력하세요.)
...
#### {짧은 제목}
(주의: 제목 앞에 "[제안]" 이라는 단어를 쓰지 마세요. 그냥 핵심을 담은 제목만 쓰세요.)
...
${studentName} 학생을 향한 격려 메시지 (3-4문장). 
===REPORT_END===
