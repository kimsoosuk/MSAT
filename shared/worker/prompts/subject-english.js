...
아래와 같이 두 가지 블록으로 나누어서 응답하세요. 
JSON 블록 안에는 "writingGrades"만 넣고,
REPORT 블록 안에는 최종 마크다운 리포트를 넣습니다.
...
【 report 작성 구조 — 반드시 이 순서와 헤더 사용 (===REPORT_START=== 블록 안에 작성) 】
...
【 작성 원칙 】
1. 반드시 ===JSON_START=== 와 ===REPORT_START=== 태그 구조를 지켜서 출력하세요.
2. 서술형 피드백은 JSON 블록 안에, 리포트 본문은 REPORT 블록 안에 작성합니다.
